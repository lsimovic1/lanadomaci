...
<body>
    ...
    <div class="container">
        ...
        <div class="modal" tabindex="-1" id="izmenaBiblioteke">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="margin-left: 145px;">Biblioteka</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="biblioteka_id">
                        ...
                        <div class="mb-2">
                            <label for="upd_adresa" class="form-label">Adresa: </label>
                            <input type="text" class="form-control" id="upd_adresa">
                        </div>
                        <div class="mb-2">
                            <label for="upd_broj_knjiga" class="form-label">Broj knjiga: </label>
                            <input type="number" class="form-control" id="upd_broj_knjiga">
                        </div>
                    </div>
                    <div class="modal-footer">
